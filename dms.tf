...
resource "aws_dms_replication_task" "dms-task" {
  ...
  table_mappings           = "{\"rules\":[{\"rule-type\":\"selection\",\"rule-id\":\"1\",\"rule-name\":\"1\",\"object-locator\":{\"schema-name\":\"testDB\",\"table-name\":\"personne\"},\"rule-action\":\"include\"}]}"
